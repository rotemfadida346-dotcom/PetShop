                      ...
                      <div className="p-2">
                        ...
                        {user && (user.email === "rotemfadida346@gmail.com" || user.email === "admin@pawsome.com") && (
                          <>
                            <Link
                              href="/admin"
                              className="flex items-center gap-3 rounded-lg px-4 py-2.5 bg-gradient-to-r from-purple-50 to-purple-100 text-purple-700 transition-all hover:from-purple-100 hover:to-purple-200 hover:shadow-md mb-2 border-2 border-purple-200"
                              onClick={() => setIsUserMenuOpen(false)}
                            >
                              <svg className="h-[18px] w-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                              </svg>
                              <span className="text-sm font-bold">פאנל ניהול</span>
                            </Link>
