...
export default function QuizFlow() {
  ...
  return (
    <div>
      {currentStep !== "results" && (
        <div className="mb-8">
          <div className="flex items-center justify-between mb-2"><span className="text-sm font-medium text-muted">שלב {step + 1} מתוך {STEPS.length - 1}</span><span className="text-sm text-muted">{Math.round(progress)}%</span></div>
