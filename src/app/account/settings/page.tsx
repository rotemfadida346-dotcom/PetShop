    ...
    <div className="bg-gray-50 min-h-screen">
      <Container size="md">
        <div className="py-8 md:py-12">
          ...
          <h1 className="text-3xl font-bold text-black tracking-tight mb-8">הגדרות חשבון</h1>
          <div className="space-y-8">
            <div className="bg-white rounded-xl border border-border p-6">
              <h2 className="text-lg font-semibold text-black mb-4">פרופיל</h2>
            ...
            <div className="bg-white rounded-xl border border-border p-6">
              <h2 className="text-lg font-semibold text-black mb-4">שינוי סיסמה</h2>
              <div className="space-y-4">
