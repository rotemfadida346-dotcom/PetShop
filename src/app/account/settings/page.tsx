    ...
    <div className="bg-surface min-h-screen">
      <Container size="md">
        <div className="py-8 md:py-12">
          ...
          <h1 className="text-3xl font-bold text-textPrimary tracking-tight mb-8">הגדרות חשבון</h1>
          <div className="space-y-8">
            <div className="bg-card rounded-xl border border-border p-6">
              <h2 className="text-lg font-semibold text-textPrimary mb-4">פרופיל</h2>
            ...
            <div className="bg-card rounded-xl border border-border p-6">
              <h2 className="text-lg font-semibold text-textPrimary mb-4">שינוי סיסמה</h2>
              <div className="space-y-4">
            ...
            <div className="bg-card rounded-xl border border-red-200 p-6">
              ...
              <p className="text-sm text-muted mb-4">מחיקת החשבון וכל הנתונים המשויכים. פעולה זו אינה הפיכה.</p>
