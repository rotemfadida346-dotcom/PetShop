      ...
      <Container size="lg">
        <div className="py-8 md:py-12">
          ...
          <div className="flex items-center justify-between mb-8">
            <h1 className="text-3xl font-bold text-text-primary tracking-tight">הכתובות שלי</h1>
              ...
              <div key={addr.id} className="bg-card rounded-xl border border-border p-6">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex items-center gap-1">
                    <button className="p-1.5 text-text-text-secondary hover:text-text-primary transition-colors"><Pencil className="h-4 w-4" /></button>
                    <button className="p-1.5 text-text-text-secondary hover:text-red-500 transition-colors"><Trash2 className="h-4 w-4" /></button>
                  </div>
                </div>
                ...
                {!addr.isDefault && <button className="mt-4 text-sm text-text-primary hover:text-text-secondary font-medium transition-colors">הגדר כברירת מחדל</button>}
              </div>
            ))}
          </div>
        </div>
