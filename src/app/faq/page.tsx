...
const FAQ_CATEGORIES = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "כן, אבל רק תוך 24 שעות מביצוע ההזמנה. צרו קשר במייל hello@pawsome.co.il או התקשרו אלינו מיד.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: "איך מחזירים מוצר?",
        a: "צרו קשר במייל hello@pawsome.co.il עם מספר ההזמנה. נשלח לכם תווית משלוח ותוכלו לשלוח את המוצר דרך הדואר או שליח.",
      },
    ],
  },
  {
