      ...
      <section className="section-padding bg-gray-50">
        <Container size="md">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-muted leading-relaxed">Pawsome נולד כשהמייסד שלנו, בעל חיות מחמד ותיק, התעייף מהמחסור באפשרויות מזון פרימיום ושקופות. אחרי חודשים של מחקר ושיתוף פעולה עם תזונאים וטרינריים, יצרנו את המתכון הראשון — והכלבים שלנו השתגעו מזה.</p>
            <p className="text-muted leading-relaxed mt-4">מאז, הרחבנו לשרת גם כלבים וגם חתולים עם קו מוצרים שלם. כל מוצר מיוצר בקבוצות קטנות עם מרכיבים שעומדים בסטנדרטים הקפדניים שלנו.</p>
            <p className="text-muted leading-relaxed mt-4">היום, מעל 10,000 בעלי חיות מחמד סומכים על Pawsome. אנחנו רק מתחילים.</p>
          </div>
        </Container>
      </section>
      <section className="section-padding">
